class IsotopeFuelParams extends IsotopeParams {
    constructor(thermalAbsorbProba, thermalScatterings, maxTemp, tempLimitLow, tempLimitHigh, neutronsMultiplication, directEnergyFactor) {
    ...
    static mix(a, b, factor) {
        ...
        const newThermalAbsorptionProba = INeutronBehaviour.probaFromCrossSection(mix(a.thermalAbsorption, b.thermalAbsorption, factor));
        const newScatteringProba = INeutronBehaviour.probaFromCrossSection(mix(a.thermalScattering, b.thermalScattering, factor));
        const newNeutronMultiplicationFactor = mix(a.neutronsMultiplication, b.neutronsMultiplication, factor);

        const totalEnergy = mix(a.neutronsMultiplication * (1 + a.directEnergyFactor), b.neutronsMultiplication * (1 + b.directEnergyFactor), factor);
...
const Isotopes = Object.freeze({
    ...
    URANIUM_238: new IsotopeFuelParams(0.6, 0.30, 3200, 1000, 3000, 6, 0.3),
